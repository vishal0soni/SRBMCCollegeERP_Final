...
from models import (
    UserRole, UserProfile, Course, CourseDetails, Subject, 
...
def create_courses_and_subjects():
    ...
    for course_data in courses_data:
        if not Course.query.filter_by(course_short_name=course_data['course_short_name']).first():
    ...
    course_details_data = [
        # Bachelor of Arts
        {'course_full_name': 'Bachelor of Arts - 1st Year', 'course_short_name': 'BA', 'year_semester': '1st Year', 'course_tuition_fee': 12000, 'total_course_fees': 15000},
        {'course_full_name': 'Bachelor of Arts - 2nd Year', 'course_short_name': 'BA', 'year_semester': '2nd Year', 'course_tuition_fee': 12000, 'total_course_fees': 15000},
        {'course_full_name': 'Bachelor of Arts - 3rd Year', 'course_short_name': 'BA', 'year_semester': '3rd Year', 'course_tuition_fee': 12000, 'total_course_fees': 15000},
        
        # Bachelor of Science
        {'course_full_name': 'Bachelor of Science - 1st Year', 'course_short_name': 'BSC', 'year_semester': '1st Year', 'course_tuition_fee': 15000, 'total_course_fees': 18000},
        {'course_full_name': 'Bachelor of Science - 2nd Year', 'course_short_name': 'BSC', 'year_semester': '2nd Year', 'course_tuition_fee': 15000, 'total_course_fees': 18000},
        {'course_full_name': 'Bachelor of Science - 3rd Year', 'course_short_name': 'BSC', 'year_semester': '3rd Year', 'course_tuition_fee': 15000, 'total_course_fees': 18000},
        
        # Master of Arts
        {'course_full_name': 'Master of Arts - 1st Year', 'course_short_name': 'MA', 'year_semester': '1st Year', 'course_tuition_fee': 20000, 'total_course_fees': 25000},
        {'course_full_name': 'Master of Arts - 2nd Year', 'course_short_name': 'MA', 'year_semester': '2nd Year', 'course_tuition_fee': 20000, 'total_course_fees': 25000},
        
        # Bachelor of Commerce
        {'course_full_name': 'Bachelor of Commerce - 1st Year', 'course_short_name': 'BCOM', 'year_semester': '1st Year', 'course_tuition_fee': 14000, 'total_course_fees': 17000},
        {'course_full_name': 'Bachelor of Commerce - 2nd Year', 'course_short_name': 'BCOM', 'year_semester': '2nd Year', 'course_tuition_fee': 14000, 'total_course_fees': 17000},
        {'course_full_name': 'Bachelor of Commerce - 3rd Year', 'course_short_name': 'BCOM', 'year_semester': '3rd Year', 'course_tuition_fee': 14000, 'total_course_fees': 17000},
    ]
    
    for detail_data in course_details_data:
        if not CourseDetails.query.filter_by(course_full_name=detail_data['course_full_name']).first():
    ...
    subjects_data = [
        # BA Subjects
        {'course_short_name': 'BA', 'subject_name': 'English Literature', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BA', 'subject_name': 'Hindi Literature', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BA', 'subject_name': 'History', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BA', 'subject_name': 'Political Science', 'subject_type': 'Elective'},
        {'course_short_name': 'BA', 'subject_name': 'Economics', 'subject_type': 'Elective'},
        {'course_short_name': 'BA', 'subject_name': 'Philosophy', 'subject_type': 'Elective'},
        {'course_short_name': 'BA', 'subject_name': 'Psychology', 'subject_type': 'Elective'},
        
        # BSC Subjects
        {'course_short_name': 'BSC', 'subject_name': 'Mathematics', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BSC', 'subject_name': 'Physics', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BSC', 'subject_name': 'Chemistry', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BSC', 'subject_name': 'Biology', 'subject_type': 'Elective'},
        {'course_short_name': 'BSC', 'subject_name': 'Computer Science', 'subject_type': 'Elective'},
        {'course_short_name': 'BSC', 'subject_name': 'Statistics', 'subject_type': 'Elective'},
        
        # MA Subjects
        {'course_short_name': 'MA', 'subject_name': 'Advanced English Literature', 'subject_type': 'Compulsory'},
        {'course_short_name': 'MA', 'subject_name': 'Research Methodology', 'subject_type': 'Compulsory'},
        {'course_short_name': 'MA', 'subject_name': 'Modern Indian History', 'subject_type': 'Elective'},
        {'course_short_name': 'MA', 'subject_name': 'International Relations', 'subject_type': 'Elective'},
        
        # BCOM Subjects
        {'course_short_name': 'BCOM', 'subject_name': 'Accounting', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BCOM', 'subject_name': 'Business Studies', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BCOM', 'subject_name': 'Economics', 'subject_type': 'Compulsory'},
        {'course_short_name': 'BCOM', 'subject_name': 'Mathematics', 'subject_type': 'Elective'},
        {'course_short_name': 'BCOM', 'subject_name': 'Computer Applications', 'subject_type': 'Elective'},
    ]
    
    for subject_data in subjects_data:
        if not Subject.query.filter_by(course_short_name=subject_data['course_short_name'], 
...
def create_students():
    ...
    first_names = [
        ...
        'Ananya', 'Aanya', 'Kiara', 'Diya', 'Pihu', 'Priya', 'Anvi', 'Riya', 'Navya', 'Kavya',
        'Rajesh', 'Suresh', 'Mahesh', 'Ramesh', 'Dinesh', 'Ganesh', 'Naresh', 'Umesh', 'Ritesh', 'Lokesh',
        'Sunita', 'Geeta', 'Seeta', 'Meera', 'Deepa', 'Reeta', 'Neeta', 'Veena', 'Leela', 'Sheela'
    ]
    
    last_names = [
        'Sharma', 'Verma', 'Gupta', 'Singh', 'Kumar', 'Agarwal', 'Jain', 'Bansal', 'Garg', 'Mittal',
        'Joshi', 'Saxena', 'Tiwari', 'Pandey', 'Mishra', 'Srivastava', 'Shukla', 'Dubey', 'Yadav', 'Patel',
        'Shah', 'Mehta', 'Modi', 'Desai', 'Thakkar', 'Vyas', 'Trivedi', 'Jha', 'Sinha', 'Mathur'
    ]
    
    father_names = [
        'Ramesh Kumar', 'Suresh Singh', 'Mahesh Sharma', 'Dinesh Gupta', 'Rajesh Verma',
        'Mukesh Agarwal', 'Naresh Jain', 'Umesh Bansal', 'Ganesh Garg', 'Lokesh Mittal'
    ]
    
    mother_names = [
        'Sunita Devi', 'Geeta Sharma', 'Meera Singh', 'Deepa Gupta', 'Seeta Verma',
        'Reeta Agarwal', 'Neeta Jain', 'Veena Bansal', 'Leela Garg', 'Sheela Mittal'
    ]
    
    cities = [
        'Raniwara', 'Jalore', 'Sirohi', 'Pali', 'Jodhpur', 'Barmer', 'Jaisalmer', 'Bikaner', 'Udaipur', 'Ajmer'
    ]
    ...
    courses = ['Bachelor of Arts - 1st Year', 'Bachelor of Arts - 2nd Year', 'Bachelor of Arts - 3rd Year',
               'Bachelor of Science - 1st Year', 'Bachelor of Science - 2nd Year', 'Bachelor of Science - 3rd Year',
               'Bachelor of Commerce - 1st Year', 'Bachelor of Commerce - 2nd Year', 'Bachelor of Commerce - 3rd Year',
               'Master of Arts - 1st Year', 'Master of Arts - 2nd Year']
    
    # Get subjects for assignment
    ba_subjects = [s.subject_name for s in Subject.query.filter_by(course_short_name='BA').all()]
    bsc_subjects = [s.subject_name for s in Subject.query.filter_by(course_short_name='BSC').all()]
    bcom_subjects = [s.subject_name for s in Subject.query.filter_by(course_short_name='BCOM').all()]
    ma_subjects = [s.subject_name for s in Subject.query.filter_by(course_short_name='MA').all()]
    ...
    for i in range(150):
        ...
        # Ensure unique ID
        while Student.query.filter_by(student_unique_id=student_unique_id).first():
            student_unique_id = generate_student_id(course_short, admission_year)
        ...
        student_data = {
            ...
            'subject_1_name': selected_subjects[0] if len(selected_subjects) > 0 else None,
            'subject_2_name': selected_subjects[1] if len(selected_subjects) > 1 else None,
            'subject_3_name': selected_subjects[2] if len(selected_subjects) > 2 else None,
            'percentage': round(random.uniform(60.0, 95.0), 2),
            'street': f'{random.randint(1, 999)} Main Street',
            'area_village': f'Ward {random.randint(1, 10)}',
            'city_tehsil': random.choice(cities),
            'state': 'Rajasthan',
            'phone': f'9{random.randint(100000000, 999999999)}',
            'aadhaar_card_number': f'{random.randint(100000000000, 999999999999)}',
            'school_name': random.choice(schools),
            'scholarship_status': random.choice(['Applied', 'Approved', 'Rejected']),
            'rebate_meera_scholarship_status': random.choice(['Applied', 'Approved', 'Rejected']),
            'dropout_status': random.choice(['Active'] * 9 + ['Dropout']),  # 90% active
            'admission_date': date(admission_year, random.randint(6, 8), random.randint(1, 28))
        }
...
def create_fees_and_invoices():
    ...
    for student in students:
        ...
        fee_data = {
            ...
            'course_tuition_fee': course_detail.course_tuition_fee,
            'enrollment_fee': 500,
