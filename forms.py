...
class StudentForm(FlaskForm):
    ...
    gender = SelectField('Gender', choices=[('', 'Select Gender'), ('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')])
    category = SelectField('Category', choices=[('', 'Select Category'), ('General', 'General'), ('SC', 'SC'), ('ST', 'ST'), ('OBC', 'OBC')])
    email = StringField('Email')
    current_course = SelectField('Current Course', choices=[('', 'Select Course')])
    subject_1_name = SelectField('Subject 1', choices=[('', 'Select Subject')])
    subject_2_name = SelectField('Subject 2', choices=[('', 'Select Subject')])
    subject_3_name = SelectField('Subject 3', choices=[('', 'Select Subject')])
    percentage = DecimalField('Percentage')
    street = StringField('Street Address')
    area_village = StringField('Area/Village')
    city_tehsil = StringField('City/Tehsil')
    state = StringField('State')
    phone = StringField('Phone')
    aadhaar_card_number = StringField('Aadhaar Number')
    apaar_id = StringField('APAAR ID')
    ...
    admission_date = DateField('Admission Date')
